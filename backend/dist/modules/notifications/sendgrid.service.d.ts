...
export declare class SendGridService {
    ...
    sendPaymentFailedEmail(email: string, businessName: string, reason: string): Promise<void>;
    sendAccountLockedEmail(email: string, firstName: string): Promise<void>;
    sendPayoutProcessedEmail(businessEmail: string, businessName: string, amount: number): Promise<void>;
