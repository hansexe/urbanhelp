...
const business_approval_service_1 = require("./business-approval.service");
...
exports.BusinessesModule = BusinessesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [businesses_service_1.BusinessesService, abn_validation_service_1.ABNValidationService, business_approval_service_1.BusinessApprovalService],
        exports: [businesses_service_1.BusinessesService, business_approval_service_1.BusinessApprovalService],
    })
], BusinessesModule);
