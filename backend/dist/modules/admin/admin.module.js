...
exports.AdminModule = AdminModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([business_entity_1.BusinessEntity, user_entity_1.UserEntity]),
            notifications_module_1.NotificationsModule,
        ],
        controllers: [admin_controller_1.AdminController],
        providers: [business_approval_service_1.BusinessApprovalService],
        exports: [business_approval_service_1.BusinessApprovalService],
    })
], AdminModule);
