...
exports.PaymentsModule = PaymentsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([payment_entity_1.PaymentEntity, booking_entity_1.BookingEntity]), cache_module_1.CacheModule],
        controllers: [payments_controller_1.PaymentsController],
        providers: [stripe_payment_service_1.StripePaymentService],
        exports: [stripe_payment_service_1.StripePaymentService],
    })
], PaymentsModule);
