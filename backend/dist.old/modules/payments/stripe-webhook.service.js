...
var StripeWebhookService_1, StripeWebhookController_1;
var _a;
Object.defineProperty(exports, "__esModule", { value: true });
exports.PaymentWebhookModule = exports.StripeWebhookController = exports.StripeWebhookService = void 0;
...
let StripeWebhookService = StripeWebhookService_1 = class StripeWebhookService {
    constructor(paymentRepository, bookingRepository, businessRepository, sendGridService, auditService, dataSource) {
    ...
    async handlePaymentIntentSucceeded(paymentIntent) {
        await this.dataSource.transaction(async (manager) => {
            try {
                ...
                this.logger.error(`Error processing payment_intent.succeeded: ${error.message}`, error.stack);
                await this.auditService.log({
                    action: 'PAYMENT_WEBHOOK_ERROR',
                    details: { error: error.message, intentId: paymentIntent.id },
                    status: 'FAILURE',
                });
    ...
    async handlePaymentIntentPaymentFailed(paymentIntent) {
        try {
            ...
            this.logger.error(`Error processing payment_intent.payment_failed: ${error.message}`);
            throw error;
        }
    }
    /**
    ...
    async handleChargeRefunded(charge) {
        try {
            ...
            this.logger.error(`Error processing charge.refunded: ${error.message}`);
            throw error;
        }
    }
    /**
    ...
    async handlePayoutPaid(payout) {
        try {
            ...
            this.logger.error(`Error processing payout.paid: ${error.message}`);
            throw error;
        }
    }
    /**
    ...
    async handleAccountUpdated(account) {
        try {
            ...
            this.logger.error(`Error processing account.updated: ${error.message}`);
            throw error;
        }
    }
    /**
...
exports.StripeWebhookService = stripe_webhook_service_1.StripeWebhookService = StripeWebhookService_1 = __decorate([
    ...
    __metadata("design:paramtypes", [typeorm_2.Repository,
        ...
        typeorm_2.Repository,
        sendgrid_service_1.SendGridService, typeof (_a = typeof audit_service_1.AuditService !== "undefined" && audit_service_1.AuditService) === "function" ? _a : Object, typeorm_3.DataSource])
...
Object.defineProperty(exports, "StripeWebhookService", { enumerable: true, get: function () { return stripe_webhook_service_1.StripeWebhookService; } });
let StripeWebhookController = StripeWebhookController_1 = class StripeWebhookController {
    ...
    async handleStripeWebhook(body, signature) {
        ...
        try {
            ...
            // Re-throw to let NestJS send 400 (webhook will retry)
            throw error;
        }
    }
};
...
__decorate([
    ...
    __param(1, (0, common_2.Headers)('stripe-signature')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], stripe_webhook_controller_1.StripeWebhookController.prototype, "handleStripeWebhook", null);
exports.StripeWebhookController = stripe_webhook_controller_1.StripeWebhookController = StripeWebhookController_1 = __decorate([
    (0, common_2.Controller)('stripe'),
...
// In main.ts - CRITICAL: Configure raw body middleware for webhook endpoint
const express_1 = __importDefault(require("express"));
async function bootstrap() {
    const app = await NestFactory.create(AppModule);
    // MUST preserve raw body for Stripe webhook verification
    // Do this BEFORE parsing JSON for other routes
...
Object.defineProperty(exports, "StripeWebhookController", { enumerable: true, get: function () { return stripe_webhook_controller_1.StripeWebhookController; } });
const notifications_module_1 = require("../notifications/notifications.module");
const common_module_1 = require("../common/common.module");
let PaymentWebhookModule = class PaymentWebhookModule {
};
exports.PaymentWebhookModule = PaymentWebhookModule;
exports.PaymentWebhookModule = PaymentWebhookModule = __decorate([
    (0, common_3.Module)({
        imports: [
            typeorm_4.TypeOrmModule.forFeature([payment_entity_1.PaymentEntity, booking_entity_1.BookingEntity, business_entity_1.BusinessEntity]),
